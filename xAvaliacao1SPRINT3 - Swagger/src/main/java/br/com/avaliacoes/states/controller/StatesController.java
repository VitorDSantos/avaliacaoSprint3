...
public class StatesController {
	...
	@PostMapping("/states")
	@ApiOperation(value= "Adiciona estados")
	...
	@ApiOperation(value= "Lista um  unico estado")
	@Transactional
...
//************************************************/**********************************************
	...
	@ApiOperation(value= "Lista os estados por maior populacao")
	@Cacheable(value = "lista" )

	public Page<StatesDto> lista(@RequestParam(required = false) String nome,
			@PageableDefault(sort = "populacao",direction = Direction.ASC,page = 0, size = 27) Pageable paginacao ){
...
//************************************************/**********************************************
		...
		@ApiOperation(value= "Lista os estados por maior area")
		@Cacheable(value = "lista" )

		public Page<StatesDto> listar(@RequestParam(required = false) String nome,
				@PageableDefault(sort = "area",direction = Direction.ASC,page = 0, size = 27) Pageable paginacao ){
...
//************************************************/**********************************************
			...
			@ApiOperation(value= "Lista os estados por regiao")
			@Cacheable(value = "lista" )
...
//************************************************/**********************************************
	...
	@ApiOperation(value= "Atualiza estado")
	@Transactional
	...
	@ApiOperation(value= "Deleta estado")	
	@Transactional
